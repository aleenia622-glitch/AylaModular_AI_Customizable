...
FUNCTION_DECLARATIONS.append({"name": "fechar_app", "description": "Fecha processo", "parameters": {"type": "object", "properties": {"nome_processo": {"type": "string"}}, "required": ["nome_processo"]}})
