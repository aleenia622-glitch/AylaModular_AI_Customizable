...
FUNCTION_DECLARATIONS.append({
    ...
    "description": "Controla a música ou vídeo que está tocando no computador do(a) usuário(a). Você pode pausar, dar play, pular para a próxima ou voltar para a anterior.",
    "parameters": {
        "type": "object",
        "properties": {
            "acao": {
