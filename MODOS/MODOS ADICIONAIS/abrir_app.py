...
try:
    ...
    FUNCTION_DECLARATIONS.append({"name": "abrir_app", "description": "Abre programa", "parameters": {"type": "object", "properties": {"nome_ou_caminho": {"type": "string"}}, "required": ["nome_ou_caminho"]}})
except NameError:
    pass
