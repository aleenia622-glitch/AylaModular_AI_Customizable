...
def modo_brincalhao(escolha: str = None) -> str:
    ...
    # Salva o estado original do FAILSAFE e desativa
    ...
    try:
        if escolha == "minimizar":
            ...
            for _ in range(5):
                ...
                pyautogui.moveRel(-10, -10, duration=0.05)
            ret_val = "✅ Fiz o mouse tremer de emoção! 💓"
            
        elif escolha == "caps_lock_troll":
            pyautogui.press("capslock")
            ret_val = "✅ Ativei/Desativei o Caps Lock! ⌨️"
            ...
            for _ in range(3):
                subprocess.Popen("calc.exe")
                time.sleep(0.3)
            ret_val = "✅ Abri MÚLTIPLAS calculadoras! 🧮🧮🧮"
            ...
            for _ in range(3):
                ...
                time.sleep(0.2)
            ret_val = "✅ Hahaha! Toquei sons de riso! 😂"
            ...
            for _ in range(5):
                ...
                pyautogui.click(x, y)
                time.sleep(0.2)
            ret_val = "✅ Cliquei aleatoriamente na tela! 🖱️✨"
            ...
            pyautogui.moveTo(pyautogui.position()[0] + 100, pyautogui.position()[1] + 100, duration=0.5)
            ret_val = "✅ Inverti o mouse de cabeça para baixo! 🙃"
