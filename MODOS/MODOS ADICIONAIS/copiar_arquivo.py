...
FUNCTION_DECLARATIONS.append({"name": "copiar_arquivo", "description": "Copia arquivo", "parameters": {"type": "object", "properties": {"origem": {"type": "string"}, "destino": {"type": "string"}}, "required": ["origem", "destino"]}})
