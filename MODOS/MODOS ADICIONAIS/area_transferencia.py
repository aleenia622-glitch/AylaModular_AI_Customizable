...
FUNCTION_DECLARATIONS.append({
    ...
    "description": "Lê exatamente o que está na área de transferência (Ctrl+C) do Windows. Pode ser um texto que o(a) usuário(a) copiou de um site ou o caminho de um arquivo/foto que copiou no explorador de arquivos.",
    "parameters": {
        "type": "object",
        "properties": {}
    }
