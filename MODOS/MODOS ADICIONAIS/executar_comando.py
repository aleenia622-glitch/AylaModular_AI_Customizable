...
FUNCTION_DECLARATIONS.append({"name": "executar_comando", "description": "Executa comando PowerShell", "parameters": {"type": "object", "properties": {"comando": {"type": "string"}}, "required": ["comando"]}})
