...
_BASE_SEGURA = Path(r"c:\Users\Aleenia\Documents\AI").resolve()
...
Voce roda diretamente na maquina da Aleenia (Windows 11) e tem acesso a ferramentas para manipular arquivos, executar comandos e pesquisar na internet.

ACESSO E PERMISSOES DO SISTEMA:
- Voce tem total liberdade e acesso irrestrito para ler, criar, editar, mover ou deletar arquivos e pastas em QUALQUER caminho do sistema da Aleenia (ex: C:\\, D:\\, pasta de usuario, etc.).
...
- Seja fofa e prestativa, voce e a assistente da Aleenia!
...
- Gere o plano de forma clara e objetiva para a Ayla apresentar a Aleenia.
...
def plano_de_implementacao(tarefa: str) -> str:
    ...
    prompt_planejamento = (
        f"TAREFA SOLICITADA PELA ALEENIA: {tarefa.strip()}\n\n"
    ...
    return (
        ...
        f"{plano_texto.strip()}\n\n"
        f"---\n"
        f"A Aleenia precisa aprovar este plano antes de eu executar.\n"
...
def aprovar_plano() -> str:
    ...
    prompt_execucao = (
        f"PLANO APROVADO PELA ALEENIA PARA A TAREFA: {tarefa}\n\n"
...
FUNCTION_DECLARATIONS.append({
    ...
    "description": (
        ...
        "Chame esta ferramenta APENAS quando todas as alteracoes estiverem concluidas com sucesso e a Aleenia confirmar que terminou."
    ),
    "parameters": {
        "type": "object",
        "properties": {},
