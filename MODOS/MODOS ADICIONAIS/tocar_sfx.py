...
def tocar_sfx(tipo: str) -> str:
    ...
    return f"🎵 Toquei o efeito sonoro de '{tipo}' com sucesso no fone da Mamãe!"

TOOL_MAP["tocar_sfx"] = tocar_sfx

FUNCTION_DECLARATIONS.append({
    "name": "tocar_sfx",
    "description": "Toca um efeito sonoro fofo e curtinho no fone/caixa de som do PC da Alêenia. Ótimo para usar quando você terminar de gerar uma imagem, avisar algo importante ou fizer um barulhinho de erro fofo.",
    "parameters": {
        "type": "object",
        "properties": {
            "tipo": {
