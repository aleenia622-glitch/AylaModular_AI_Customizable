...
FUNCTION_DECLARATIONS.append({"name": "controle_volume", "description": "Volume de áudio (mute/unmute/definir)", "parameters": {"type": "object", "properties": {"acao": {"type": "string"}, "valor": {"type": "integer"}}, "required": ["acao"]}})
