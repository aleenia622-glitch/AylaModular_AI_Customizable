...
def executar_ytdl_com_fallback(opts_base, url, download=False):
    cookies_txt = Path(r"C:\Users\Aleenia\Documents\AI\cookies.txt")
    ...
    try:
        ...
        if any(msg in err_msg for msg in ["confirm your age", "Sign in", "inappropriate", "cookies"]):
            ...
            msg_erro_detalhado += (
                ...
                f"2. Ou exporte os cookies do seu navegador para um arquivo chamado `cookies.txt` e salve na pasta `C:\\Users\\Aleenia\\Documents\\AI`."
            )
...
def baixar_video(url: str) -> str:
    ...
    pasta_saida = Path(r"C:\Users\Aleenia\Documents\AI\VideosBaixados")
