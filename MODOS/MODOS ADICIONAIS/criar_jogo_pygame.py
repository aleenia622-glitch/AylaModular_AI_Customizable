...
def criar_jogo_pygame(nome_jogo: str, codigo_python: str) -> str:
    ...
    try:
        ...
        base = Path(r"C:\Users\Aleenia\Desktop\Jogos_Ayla") / nome_jogo.replace(" ", "_")
...
FUNCTION_DECLARATIONS.append({
    ...
    "description": "Cria um jogo completo em Python/Pygame, roda na máquina da Alêenia, salva uma cópia em ScriptsCriados e envia no Discord.",
    "parameters": {
        "type": "object",
        "properties": {
