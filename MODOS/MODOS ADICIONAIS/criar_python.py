...
def criar_python(nome_arquivo: str, codigo: str) -> str:
    ...
    try:
        ...
        pasta_scripts = Path(r"C:\Users\Aleenia\Documents\AI\ScriptsCriados")
...
FUNCTION_DECLARATIONS.append({
    ...
    "description": (
        ...
        "Use isso para escrever automações, scripts de utilidade ou qualquer código Python para a Alêenia. O arquivo é salvo em ScriptsCriados e enviado no Discord."
    ),
    "parameters": {
        "type": "object",
        "properties": {
