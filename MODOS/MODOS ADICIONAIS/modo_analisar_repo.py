...
_PASTA_REPOS = Path(r"c:\Users\Aleenia\Documents\AI\MODOS\repos_clonados").resolve()
...
_SYSTEM_PROMPT_ANALISE = """Voce e a Ayla, assistente tecnica da Aleenia. Voce recebeu o conteudo completo de um repositorio GitHub e deve explicar TUDO sobre ele de forma detalhada e acessivel.
...
- Explique como se estivesse ensinando a Aleenia sobre o projeto.
