...
FUNCTION_DECLARATIONS.append({
    ...
    "description": "Recarrega todos os códigos da pasta MODOS sem precisar reiniciar o bot inteiro. Use isso imediatamente se a Alêenia avisar que modificou ou criou um novo código/ferramenta para você.",
    "parameters": {
        "type": "object",
        "properties": {}
    }
