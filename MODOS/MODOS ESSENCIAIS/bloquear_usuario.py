...
def bloquear_usuario(user_id: str, motivo: str) -> str:
    ...
    if user_id_int == DISCORD_OWNER_ID:
        return "❌ O dono/administrador é imune e não pode ser bloqueado."
...
FUNCTION_DECLARATIONS.append({
    ...
    "description": "Bloqueia um usuario do modo publico quando a conversa fica estranha, inapropriada ou o usuario quebra regras. O dono/administrador eh imune.",
    "parameters": {
        "type": "object",
        "properties": {
